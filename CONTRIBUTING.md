...
1. Fork it ( <https://gitlab.com/go-volary/volary-opera/fork> )
...
* [feature requests filed as issues](https://gitlab.com/go-volary/volary-opera/labels/enhancement) that impact end-user [contributors](https://gitlab.com/go-volary/volary-opera/labels/contributor) and [developers](https://gitlab.com/go-volary/volary-opera/labels/developer)
* changes to the [architecture](https://gitlab.com/go-volary/volary-opera/labels/architecture) that make it easier for contributors (in the GitHub sense), dev-ops, and deployers to maintain and run blockscout
...
* [ ] Title
  ...
  * (bug) for [bug](https://gitlab.com/go-volary/volary-opera/labels/bug) fixes
  * (enhancement) for [enhancement](https://gitlab.com/go-volary/volary-opera/labels/enhancement)s
  * (incompatible changes) for [incompatible changes](https://gitlab.com/go-volary/volary-opera/labels/incompatible%20changes), such a refactor that removes functionality, changes arguments, or makes something required that wasn't previously.
...
See [#255](https://gitlab.com/go-volary/volary-opera/pull/255) as an example PR that uses GitHub keywords and a Changelog to explain multiple changes.
